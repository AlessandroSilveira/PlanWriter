...
public class GetActiveEventsQueryHandler(IEventReadRepository eventReadRepository, IEventLifecycleService eventLifecycleService, ILogger<GetActiveEventsQueryHandler> logger)
