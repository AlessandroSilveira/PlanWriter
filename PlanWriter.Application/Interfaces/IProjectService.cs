...
namespace PlanWriter.Application.Interfaces
{
    public interface IProjectService
    {
        ...
        Task<bool> SetGoalAsync(Guid projectId, Guid userId, int wordCountGoal, DateTime? deadline);
        ...
        Task<bool> DeleteProgressAsync(Guid progressId, Guid userId);
        ...
        Task<int> GetMonthlyTotalAsync(Guid userId);
    }
}